...
const ChefInfo = ({ chef }) => {
    const { chefPicture, chefName, experience, likes, recipesNum } = chef
    return (
        <div className='w-80 p-5 border-2 rounded-xl border-orange-300 hover:bg-orange-50'>
            ...
            <div className='text-center my-5'>
                ...
                <Link><button className='bg-gradient-to-r from-orange-600 to-orange-300 p-3 rounded text-white font-semibold'>View Recipes Button</button></Link>
            </div>
        </div>
    );
};
