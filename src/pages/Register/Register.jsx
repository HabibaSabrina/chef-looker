    ...
    return (
        <div>
            ...
            <p className='font-semibold '>Name</p>
                <input className='mb-5 border-b-2 focus:outline-0 focus:text-center border-orange-300 mt-5 w-80' type="text" name="name" />
                <br />
                <p className='font-semibold mt-5'>Email</p>
                <input className='border-b-2 focus:outline-0 focus:text-center border-orange-300 mt-5 w-80' type="email" name="email" />
                <br />
                <p className='font-semibold mt-10'>Password</p>
                <input className='border-b-2 focus:outline-0 focus:text-center border-orange-300 mt-5 w-80' type="password" name="password" />
                <br />
                <p className='font-semibold mt-10'>Photo URL</p>
                <input className='border-b-2 focus:outline-0 focus:text-center border-orange-300 mt-5 w-80' type="password" name="photo" />
                <br />
